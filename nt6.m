...
hold off
axis([0 TMax 0 110]);
legend(dec2hex(SelBin(1)), dec2hex(SelBin(2)), dec2hex(SelBin(3)), dec2hex(SelBin(4)), dec2hex(SelBin(5)), dec2hex(SelBin(6)));
legend('Location', 'northoutside');
legend('Orientation','horizontal');
xlabel("time [hours]");
ylabel("Bin Level [%]");
title("Bin Level and G. C. State evolution");
